          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <h3 className="text-xl font-bold mb-3">Expertise-Driven</h3>
                <p className="text-gray-700">
              ...
              <div>
                <h3 className="text-xl font-bold mb-3">Efficiency-Focused</h3>
                <p className="text-gray-700 mb-6">
                ...
                <h3 className="text-xl font-bold mb-3">Globally Connected</h3>
                <p className="text-gray-700">
