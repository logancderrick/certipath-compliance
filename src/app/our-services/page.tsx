        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-white/80">
              Comprehensive compliance solutions for your global business needs
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-16 bg-blue-50 rounded-lg p-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-900">Global Markets We Serve</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              <div>
                <h3 className="text-lg font-bold mb-3 text-gray-900">Asia Pacific</h3>
              ...
              <div>
                <h3 className="text-lg font-bold mb-3 text-gray-900">Americas</h3>
                <ul className="space-y-2 text-gray-700">
              ...
              <div>
                <h3 className="text-lg font-bold mb-3 text-gray-900">EMEA</h3>
                <ul className="space-y-2 text-gray-700">
                  <li>Europe</li>
                  <li>Eurasia</li>
                  <li>Africa</li>
