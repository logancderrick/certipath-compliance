        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <h2 className="text-xl font-bold mb-2 text-[var(--secondary-color)]">Email</h2>
              <p className="text-gray-600">contact@certipathcompliance.com</p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <h2 className="text-xl font-bold mb-2 text-[var(--secondary-color)]">Phone</h2>
              <p className="text-gray-600">214-771-8157</p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <h2 className="text-xl font-bold mb-2 text-[var(--secondary-color)]">Business Hours</h2>
              <p className="text-gray-600">Monday - Friday: 9AM - 5PM CST</p>
            </div>
          </div>
