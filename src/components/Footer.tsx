            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <a href="tel:214-771-8157" className="text-lg font-medium text-[var(--primary-color)] hover:text-[var(--primary-dark)] transition-colors">
                    214-771-8157
                  </a>
                </div>
                <div>
                  <p className="text-gray-600 mb-1">Email</p>
                  <a href="mailto:contact@certipathcompliance.com" className="text-lg font-medium text-[var(--primary-color)] hover:text-[var(--primary-dark)] transition-colors break-all">
